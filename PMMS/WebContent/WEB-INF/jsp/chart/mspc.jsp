...
<title>PMMS - MSPC维修配件费用统计</title>
	...
	<script src="<%=contextPath%>/js/chart-mspc.js" ></script>
			...
			<div class="form-group">
				<div>
					<label class="col-sm-2 control-label pull-left" for="planYear"> 年份/Select Year： </label>
			      	...
			      	<div class="col-sm-3 pull-left"  >
		      			<input id="sp-id" type="text" class="form-control"  placeholder="要查询单个备件，请输入备件编号" >
		      		</div>
		   		</div>
		   </div>
	        ...
	        <div class="span12">            
				<section class="module">
					<div class="module-body">
						...
						<div id="maint-cost-div" class="table-responsive">
							<div class="input-append flR pull-right">
							...
							<table id="maint-cost-table" class="table table-bordered table-striped tablebrdr mrgzero width100p" data-table-name="maint-cost-table"></table>
						</div>
						<br><br>
