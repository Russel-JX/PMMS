...
<title>PMMS - MTTR平均维修时间统计</title>
	...
	<script src="<%=contextPath%>/js/chart-mttr.js" ></script>
	        ...
	        <div class="span12">            
				<section class="module">
					<div class="module-body">
						...
						<div id="chart-mttr-div" class="table-responsive">
							<div class="input-append flR pull-right">
							...
							<table id="chart-mttr-table" class="table table-bordered table-striped tablebrdr mrgzero width100p" data-table-name="chart-mttr-table"></table>
						</div>
						<br><br>
