...
<title>PMMS - MSPQU维修配件使用数量统计</title>
	...
	<script src="<%=contextPath%>/js/chart-mspqu.js" ></script>
			...
			<div class="form-group">
				<div>
					<label class="col-sm-2 control-label pull-left" for="planYear"> 年份/Select Year： </label>
		      		...
		      		<label class="col-sm-2 control-label pull-left" for="sp-name"> 备件名称/EQNAME： </label>
			      	<div class="col-sm-3 pull-left" >
		      			<input id="sp-name" type="text" class="form-control"  placeholder="请输入备件名称" >
		      		</div>
		      		<label class="col-sm-2 control-label pull-left" for="sp-id"> 备件编号/SPNO.： </label>
			      	<div class="col-sm-3 pull-left"  >
		      			<input id="sp-id" type="text" class="form-control"  placeholder="要查询单个备件，请输入设备编号" >
		      		</div>
		   		</div>
		   </div>
	        ...
	        <div class="span12">            
				<section class="module">
					<div class="module-body">
						...
						<div id="maint-quantity-div" class="table-responsive">
							<div class="input-append flR pull-right">
											<input type="text" class="input-medium search-query" data-filter-table="maint-quantity-table"><button class="btn btn-icon"><i class="icon-search"></i></button>
										</div>
							<table id="maint-quantity-table" class="table table-bordered table-striped tablebrdr mrgzero width100p" data-table-name="maint-quantity-table"></table>
						</div>
						<br><br>
