...
<title>PMMS - PM完成率统计</title>
	...
	<script src="<%=contextPath%>/js/chart-pm.js" ></script>
	        ...
	        <div class="span12">            
				<section class="module">
					<div class="module-body">
						...
						<div id="pm-completion-div" class="table-responsive">
							<div class="input-append flR pull-right">
							...
							<table id="pm-completion-table" class="table table-bordered table-striped tablebrdr mrgzero width100p" data-table-name="pm-completion-table"></table>
						</div>
