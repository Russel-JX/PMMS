...
<title>PMMS - MTBF平均维修间隔时间统计</title>
	...
	<script src="<%=contextPath%>/js/chart-mtbf.js" ></script>
	        ...
	        <div class="span12">            
				<section class="module">
					<div class="module-body">
						...
						<div id="maint-gap-div" class="table-responsive">
							<div class="input-append flR pull-right">
							...
							<table id="maint-gap-table" class="table table-bordered table-striped tablebrdr mrgzero width100p" data-table-name="maint-gap-table"></table>
						</div>
						<br><br>
