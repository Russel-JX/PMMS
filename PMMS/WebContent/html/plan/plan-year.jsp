  ...
  <body>
	...
	<div class="container">
		<div class="page-header">
			<div>
				<h1 class="voice voice-brand pull-left">全年保养计划</h1>
			</div>
			
			<!-- <div>
				<div> </div><div> </div><div> </div>
				<a href="/PMMS/html/MaintItem/maintItem.html"><button class="btn btn-large btn-primary pull-right"  id="btn-show-maintItem">查看保养内容</button></a>
				<div> </div><div> </div><div> </div>
			</div> -->
			
			<div>
				<div> </div><div> </div><div> </div>
				<a href="<%=contextPath%>/plan/copy.htm"><button class="btn btn-large btn-primary pull-right" style="margin-right:6px;"  id="btn-show-maintItem">制定全年计划</button></a>
				<div> </div><div> </div><div> </div>
			</div>
		</div>
				...
				<section class="module">
					<div class="module-body">
						<div class="btn-group pull-left">
							<div class="pull-left">
								      <label class="col-sm-2 control-label pull-left" for="maintYear"> 请选择年份： </label>
							...
							<a data-placement="bottom" title="导出到Excel" data-title="Export to Excel" rel="tooltip" class="btn btn-icon" href="#" data-original-title=""><i class=" icon-download-alt"></i></a>
								<button class="btn btn-primary pull-left " type="submit"  id="btn-add-plan">增加计划</button>
								<button class="btn btn-primary pull-left" type="submit"  id="btn-modify-plan">编辑计划</button>
								<button class="btn btn-primary pull-left" type="submit"  id="deleteButton" data-toggle="modal"  data-target="#modal-delete-plan">删除计划</button>
		...
		<div class="page-header">
			<div>
				<h1 class="voice voice-brand pull-left">月度保养计划</h1>
			</div>
			<div class="row ui-sortable">
	        <div class="span12">            
				<section class="module">
	...
	<div class="modal-body">
		<div class="module-body">
			<form style="margin-bottom:0;" class="form-horizontal">	
				<div class="well">	
					...
					<div class="sec-lft pull-left" style="width:50%">
						<div class="control-group">
									<label class="control-label" for="equipId" style="width:120px;"><b>请输入设备编号:</b></label>
									<div class="controls" style="margin-left:110px;">
										<input id="equipId" type="text" placeholder="请输入设备编号" class="span3">
									</div>
								</div>
						<div class="control-group">
							<label class="control-label" for="equipType" style="width:100px;"><b>设备类型:</b></label>
							<div class="controls" style="margin-left:110px;">
										<input id="equipType" type="text" placeholder="" class="span3" disabled ><!-- 设备有效！ -->
									</div>
						</div>
						<div class="control-group">
					...
					<div class="sec-rht pull-right" style="width:50%">
						<div class="control-group">
							<label class="control-label" for="equipName" style="width:100px;"><b>设备名称:</b></label>
							<div class="controls" style="margin-left:110px;">
								<input id="equipName" type="text" placeholder="" class="span3" disabled>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="equipModal" style="width:100px;"><b>设备型号:</b></label>
							<div class="controls" style="margin-left:110px;">
				...
				<div class="well">	
					<div class="page-header">
						<div>
							<h3 class="voice voice-brand pull-left">第三步：选择保养月份</h3>
						</div>
					</div>			
					<fieldset>
									...
									<tbody role="alert" aria-live="polite" aria-relevant="all">
										<tr class="odd maint-month">
											<td>
												...
												<div class="pull-left"><input type="checkbox" id="quarter-1"><br><label for="quarter-1">季</label></div>
											...
											<td>
												...
												<div class="pull-left"><input type="checkbox" name="quarter-1"><br><label for="quarter">季</label></div>
 	...
 	<div class="modal-footer">
		...
		<button href="#" class="btn btn-primary" id="plan-add-confirm">完成</button>
		<button href="#" class="btn btn-primary" id="plan-modify-confirm">完成</button>
	...
	<div class="modal-body">
		<div class="module-body">
			<form style="margin-bottom:0;" class="form-horizontal">	
				...
				<div class="page-header">
					<div>
						<h3 class="voice voice-brand pull-left">确定删除编号是 sp001 的设备吗？</h3>
					</div>
				</div>			
				</div>
			</form>
