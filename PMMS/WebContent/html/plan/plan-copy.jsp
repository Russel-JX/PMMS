				...
				<section class="module">
					<div class="module-body">
						<div class="btn-group pull-left">
								<div class="pull-left">
								      <label class="col-sm-2 control-label pull-left icon-file" for="copyFrom">复制此年份的计划： </label>
								...
								<div class="pull-left">
								      <label class="col-sm-2 control-label pull-left  icon-paste" for="copyTo"> 到此年份的计划： </label>
								...
								<button class="btn btn-primary pull-left" style="margin-left:20px;" type="submit"  id="btn-copy-plan">复制计划</button>
						</div>
					</div>
	...
	<div id="modal-copy-confirm" class="modal modal3 hide fade" style="display: none;">
		...
		<div class="modal-body">
	 	...
	 	<div class="modal-footer">
			<button href="#" class="btn btn-primary btn-copy-confirm">确定</button>
		...
		<div class="modal-body">
			<div class="module-body">
				<form style="margin-bottom:0;" class="form-horizontal">	
					...
					<div class="page-header">
						<div>
							<h3 id="no-plan-msg" class="voice voice-brand pull-left">没有计划</h3>
						</div>
					</div>			
					</div>
				</form>
